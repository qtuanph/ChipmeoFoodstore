...
<div class="space-y-6 p-6">
	...
	{:else if vm.stats}
			...
			<div class="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-md">
				<div class="flex items-center justify-between">
					...
					<div class="text-right">
						...
						<p class="mt-1 text-2xl font-black text-gray-900">{formatCurrency(vm.stats.today.revenue)}</p>
					</div>
				</div>
			...
			<div class="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-md">
				<div class="flex items-center justify-between">
					...
					<div class="text-right">
						...
						<p class="mt-1 text-2xl font-black text-gray-900">{formatCurrency(vm.stats.month.revenue)}</p>
					</div>
				</div>
				<div class="mt-4 flex items-center justify-between text-sm">
		...
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
			...
			<div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm lg:col-span-2">
				<div class="mb-6 flex items-center justify-between">
					<h3 class="text-lg font-bold text-gray-900 text-[15px]">Biểu đồ doanh thu (7 ngày qua)</h3>
					<div class="rounded-lg bg-indigo-50 px-2 py-1 text-[10px] font-bold text-indigo-600 uppercase tracking-tight">AI Predicted</div>
				</div>
		...
		<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
			<!-- Popular Items -->
			<div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
				<h3 class="mb-6 text-lg font-bold text-gray-900 text-[15px]">Món bán chạy (Hôm nay)</h3>
			...
			<!-- Popular Combos -->
			<div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
				<h3 class="mb-6 text-lg font-bold text-gray-900 text-[15px]">Combo bán chạy (Hôm nay)</h3>
